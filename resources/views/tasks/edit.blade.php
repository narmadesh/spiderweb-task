        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900">
                    <form action="{{ route('tasks.update', ['task' => $task]) }}" class="flex flex-col gap-4"
                        method="post">
                        @csrf
                        @method('PUT')
                        <div>
                        ...
                        <div>
                            ...
                            <x-textarea id="description" class="block mt-1 w-full" name="description" :value="$task->description"
                                required />
